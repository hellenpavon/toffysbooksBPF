...
class PDF extends FPDF {
    function Header() {
        ...
        // Centrando el subtítulo "REPORTE DE ESTUDIANTES"
...
$query = "SELECT id, identidad, nombre, apellido, telefono FROM estudiante_hp";
...
foreach ($result as $row) {
    ...
    $pdf->Cell(50, 10, utf8_decode($row['apellido']), 1, 0, 'C');
