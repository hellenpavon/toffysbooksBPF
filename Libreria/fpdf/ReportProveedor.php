...
class PDF extends FPDF {
    function Header() {
        ...
        // Centrando el subtítulo "REPORTE DE PROVEEDORES"
...
$query = "SELECT id, nombre, email, direccion, telefono FROM proveedores";
...
foreach ($result as $row) {
    ...
    $pdf->Cell(50, 10, utf8_decode($row['direccion']), 1, 0, 'C');
