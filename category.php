...
<?php
    ...
    $query = $db->prepare("SELECT * FROM categoria_hp where Nombre like '%".$criterio."%';");
    $query->execute();
...
<head>
    ...
    <style>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      ...
                      <li><a href="listcategory.php" style="color: #9F6932;">Nueva categoría</a></li>
                    </ol>
                </div>
            </div>
        </div> -->
        ...
        <form class="pull-right" style="width: 30% !important;" method="post" action="">
            <div class="group-material">
                <input type="search" style="display: inline-block !important; width: 70%;" 
                       class="material-control tooltips-general" placeholder="Buscar categoria" 
        ...
        <div class="container-fluid" style="font-family: Arial, sans-serif">
        <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">Listado de Categorías</h2>
        <button type="button" class="btn btn-warning" onclick="location.href='listcategory.php'"><i class="bi bi-plus-square"></i></button>
            <div class="div-table">
                        ...
                        foreach($rows as $key => $value){
                            echo '
                                <div class="div-table-row">
                                    ...
                                    <div class="div-table-cell">'.$value["Codigo"].'</div>
                                    <div class="div-table-cell">'.$value["Nombre"].'</div>
                                    <div class="div-table-cell">
                                        <a href="edtcategory_hp.php?id='.$value["Id"].'" class="btn btn-warning" >
                                        <i class="bi bi-pencil-square"></i>
                                        </a>
                                    </div>
                                    <div class="div-table-cell">
                                        <a href="dltcategory_hp.php?id='.$value["Id"].'" class="btn btn-danger eliminar" >
        ...
        <script>
             $(".eliminar").on("click", function(e) {
                    ...
                    if(op) {
                        ...
                        fetch('dltcategory_hp.php?id=' + id, {
                            method: "POST",
                            headers: {
