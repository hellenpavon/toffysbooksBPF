...
<?php
    ...
    $query = $db->prepare("SELECT * FROM personal_hp where Nombres like '%".$criterio."%';");
    $query->execute();
    ...
    <style>
        ...
        <div class="conteiner-fluid" style="font-family: Arial, sans-serif">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation" class="active"><a href="listpersonal.php">Personal administrativo</a></li>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">                        
                        ...
                        <li><a href="personal.php" style="color: #9F6932;">Nuevo personal</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <form class="pull-right" style="width: 30% !important;" method="post" action="">
            <div class="group-material">
                <input type="search" style="display: inline-block !important; width: 70%;" 
                       class="material-control tooltips-general" placeholder="Buscar personal" 
        ...
        <?php if (!empty($criterio)): // Verificar si hay criterio de búsqueda ?>
            <div class="pull-right" style="margin-top: 10px;">
                <a href="listpersonal.php" class="btn btn-secondary">
                <i class="bi bi-x"></i>
                </a>
            </div>
        <?php endif; ?>
            ...
            <div>
                <a href="Libreria/fpdf/ReportPersonal.php" target="_blank" class="btn btn-warning btn-lg"><i class="bi bi-file-earmark-pdf-fill"></i></a>
            </div>
            ...
            <div class="div-table-row div-table-head">
                    ...
                    <div class="div-table-cell">Cargo</div>
                        ...
                        foreach($rows as $key => $value){
                            echo '
                                <div class="div-table-row">
                                    ...
                                    <div class="div-table-cell">'.$value["Cargo"].'</div>
                                    <div class="div-table-cell">
                                        <a href="edpersonal.php?id='.$value["Id"].'" class="btn btn-warning" >
                                        <i class="bi bi-pencil-square"></i>
                                        </a>
                                    </div>
                                    <div class="div-table-cell">
                                        <a href="dltpersonal.php?id='.$value["Id"].'" class="btn btn-danger eliminar" >
