...
<?php
    ...
    $query = $db->prepare("SELECT * FROM estudiante_hp where Nombre like '%".$criterio."%';");
    $query->execute();
    ...
    <style>
        ...
        <div class="conteiner-fluid" style="font-family: Arial, sans-serif">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation" class="active"><a href="liststudent.php">Estudiantes</a></li>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="student.php" style="color: #9F6932;">Nuevo estudiante</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <form class="pull-right" style="width: 30% !important;" method="post" action="">
            <div class="group-material">
                <input type="search" style="display: inline-block !important; width: 70%;" 
                       class="material-control tooltips-general" placeholder="Buscar estudiante" 
        ...
        <?php if (!empty($criterio)): // Verificar si hay criterio de búsqueda ?>
            <div class="pull-right" style="margin-top: 10px;">
                <a href="liststudent.php" class="btn btn-secondary">
                <i class="bi bi-x"></i>
                </a>
            </div>
        <?php endif; ?>
        ...
        <div class="container-fluid" style="font-family: Arial, sans-serif">
            ...
            <div>
                <a href="Libreria/fpdf/ReportEstudiantes.php" target="_blank" class="btn btn-warning btn-lg"><i class="bi bi-file-earmark-pdf-fill"></i></a>
            </div>
            <div class="div-table">
                        ...
                        foreach($rows as $key => $value){
                            echo '
                                <div class="div-table-row">
                                    ...
                                    <div class="div-table-cell">'.$value["Apellido"].'</div>
                                    <div class="div-table-cell">'.$value["Telefono"].'</div>
                                    <div class="div-table-cell">
                                        <a href="edstudent.php?id='.$value["Id"].'" class="btn btn-warning" >
                                        <i class="bi bi-pencil-square"></i>
                                        </a>
                                    </div>
                                    <div class="div-table-cell">
                                        <a href="dltstudent.php?id='.$value["Id"].'" class="btn btn-danger eliminar" >
