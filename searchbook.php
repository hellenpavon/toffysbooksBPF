...
<html lang="es">
<head>
    <title>Buscar libro | Toffy's Books</title>
    <meta charset="UTF-8">
    ...
    <div class="content-page-container full-reset custom-scroll-containers" style="font-family: Arial, sans-serif">
        ...
        <div class="container" style="font-family: Arial, sans-serif">
            <div class="page-header">
                <img src="ImagenesHP/Toffy’s-Books.png" alt="user-picture" width="50" height="40"> <h1 class="all-tittles">Toffy’s-Books <small>Busqueda de libro</small></h1>
            </div>
        </div>
        <br><br><br>
